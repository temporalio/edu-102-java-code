...
public class PizzaWorkflowTest {
    ...
    public void testSuccessfulPizzaOrder(TestWorkflowEnvironment testEnv, Worker worker,
        ...
        OrderConfirmation confirmation = new OrderConfirmation(order.getOrderNumber(), "SUCCESS", "P24601",
                Instant.now().getEpochSecond(), 2500);

        PizzaActivities mockedActivities = mock(PizzaActivities.class, withSettings().withoutAnnotations());
    ...
    public void testFailedPizzaOrderCustomerOutsideDeliveryArea(TestWorkflowEnvironment testEnv, Worker worker,
        ...
        Exception exception = assertThrows(TemporalFailure.class, () -> {
