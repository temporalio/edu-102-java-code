...
public class PizzaActivitiesImpl implements PizzaActivities {
    ...
    public OrderConfirmation sendBill(Bill bill) {
        ...
        OrderConfirmation confirmation = new OrderConfirmation(bill.getOrderNumber(), "SUCCESS", "P24601",
                Instant.now().getEpochSecond(), chargeAmount);

        logger.debug("Sendbill complete: Confirmation Number: {}", confirmation.getConfirmationNumber());
